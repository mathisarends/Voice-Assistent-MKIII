...
class TestAlarm(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.get_mapper_patch = patch(
            "alarm.alarm.get_mapper", return_value=self.audio_manager_mock
        )
    ...
    def test_set_alarm_for_time(self):
        ...
        with freeze_time("2023-01-01 12:00:00"):
            ...
            expected_wake_time = datetime.datetime(
                2023, 1, 1, 13, 30
    ...
    def test_cancel_alarm(self):
        ...
        # Setze einen Alarm
        alarm_id = self.alarm.set_alarm_in(
            seconds=60,
    ...
    def test_get_next_alarm_info(self):
        ...
        alarm2_time = now + datetime.timedelta(
            hours=1
        )  # Dieser sollte der nächste sein

        self.alarm.set_alwarm(alarm1_time, DEFAULT_WAKE_SOUND, DEFAULT_GET_UP_SOUND)
        alarm2_id = self.alarm.set_alarm(
            alarm2_time, DEFAULT_WAKE_SOUND, DEFAULT_GET_UP_SOUND
        )
        ...
        self.assertEqual(
            returned_get_up_time,
            alarm2_time + datetime.timedelta(seconds=self.alarm.snooze_duration),
        )
    ...
    def test_trigger_alarm(self, thread_mock):
        ...
        self.alarm.set_alarm(
            past_time, DEFAULT_WAKE_SOUND, DEFAULT_GET_UP_SOUND, callback=callback_mock
        )
        ...
        self.play_loop_mock.assert_has_calls(
            [
                ...
                call(
                    DEFAULT_WAKE_SOUND,
                    self.alarm.wake_up_duration - self.alarm.fade_out_duration,
                ),
                # Get-Up-Sound
                call(
                    DEFAULT_GET_UP_SOUND,
                    self.alarm.get_up_duration - self.alarm.fade_out_duration,
                ),
            ]
        )
...
class TestAlarmIntegration(unittest.TestCase):
    ...
    def test_immediate_alarm_with_real_timing(self):
        ...
        self.alarm.set_alarm_in(
            0.1, DEFAULT_WAKE_SOUND, DEFAULT_GET_UP_SOUND, callback=callback_mock
        )

        # Warte etwas länger als die Gesamtdauer des Alarms
        expected_duration = (
            0.1  # Verzögerung bis Auslösung
