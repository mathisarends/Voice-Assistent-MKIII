...
class NotionNotesRepository(AbstractNotionClient):
    ...
    def __init__(
        ...
        super().__init__()
        self.notes_database_id = NOTION_DATABASES.get(
    ...
    async def create_note(
        ...
        request_body = {
            "parent": {"database_id": self.notes_database_id},
    ...
    async def update_note_content(self, note_id: str, content: str) -> bool:
        children_response = await self._make_request(
            "get", f"blocks/{note_id}/children"
        )
        ...
        response = await self._make_request(
            "patch", f"blocks/{note_id}/children", request_body
        )
