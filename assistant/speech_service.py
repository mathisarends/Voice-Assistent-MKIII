...
class SpeechService(LoggingMixin):
    def __init__(self, voice: str = "nova", category: str = "tts_responses", 
        ...
        self.logger.info(f"SpeechService initialisiert mit Stimme '{voice}', "
    ...
    def _process_tts_queue(self) -> None:
        ...
        while self.active:
            try:
                ...
                sound_id = self.tts_generator.generate_tts(text, self.category, self.voice)
